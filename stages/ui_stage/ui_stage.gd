...
#   as child objects of the hands (probably with a GXDKHandAttachment node)
...
@onready var _left_pointer = $GXDKCharacterBody3D/XROrigin3D/LeftCollisionHand/GXDKPointer
@onready var _right_pointer = $GXDKCharacterBody3D/XROrigin3D/RightCollisionHand/GXDKPointer
